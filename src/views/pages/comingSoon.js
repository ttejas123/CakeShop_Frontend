    ...
    <div className='misc-wrapper'>
      ...
      <div className='misc-inner p-2 p-sm-3'>
        <div className='w-100 text-center'>
          <h2 className='mb-1'>We are Coming soon </h2>
          <p className='mb-3'>We're creating something awesome. Please submit your deatls to get notified when its ready</p>
          <Form tag={Row} className='justify-content-center m-0 mb-2' inline onSubmit={e => e.preventDefault()}>
            <Col tag={Input} className='mb-1 mr-md-2' md='5' sm='12' placeholder='abc@examplemail.com' />
