...
const columns = [
  ...
  const CustomPagination = () => (
    <ReactPaginate
      ...
      pageCount={searchValue.length ? filteredData.length / 7 : dfGoodsData.length / 7 || 1}
      breakLabel={'...'}
  ...
  function convertArrayOfObjectsToCSV(array) {
    ...
    const lineDelimiter = '\n'
    const keys = Object.keys(dfGoodsData[0])
        ...
        <div className='d-flex mt-md-0 mt-1'>
            <UncontrolledButtonDropdown>
              ...
              <DropdownMenu right>
                ...
                <DropdownItem className='w-100' onClick={() => downloadCSV(dfGoodsData)}>
                  <FileText size={15} />
