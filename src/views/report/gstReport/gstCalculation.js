...
const columns = [
  ...
  const CustomPagination = () => (
    <ReactPaginate
      ...
      pageCount={searchValue.length ? filteredData.length / 7 : gstCalcData.length / 7 || 1}
      breakLabel={'...'}
  ...
  function convertArrayOfObjectsToCSV(array) {
    ...
    const lineDelimiter = '\n'
    const keys = Object.keys(gstCalcData[0])
  ...
  return (
    ...
    <Card>
      <CardHeader className='border-bottom'>
        <CardTitle tag='h4'>GST Calculation Report</CardTitle>
        <div className='d-flex mt-md-0 mt-1'>
            <UncontrolledButtonDropdown>
              ...
              <DropdownMenu right>
                ...
                <DropdownItem className='w-100' onClick={() => downloadCSV(gstCalcData)}>
                  <FileText size={15} />
