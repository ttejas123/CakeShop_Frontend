...
// ** Table Columns
import { corporateCreditData, columns } from './data'
...
const CorporateCreditRequestList = () => {

    //console.log(BankGuarranteApplsColumns)
    console.log(corporateCreditData)
  // ** State
//   const data = [
//     {
//       name: "US Dollar",
...
const columns = [
  ...
  const CustomPagination = () => (
    <ReactPaginate
      ...
      pageCount={searchValue.length ? filteredData.length / 7 : corporateCreditData.length / 7 || 1}
      breakLabel={'...'}
  ...
  return (
    ...
    <Card>
      <CardHeader className='border-bottom'>
        <CardTitle tag='h4'>Corporate Credit Request List</CardTitle>
...
export default CorporateCreditRequestList
