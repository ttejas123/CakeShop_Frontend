...
// ** Table Columns
import { creditTransactionsData, columns } from './data'
...
const CreditTransactionsList = () => {
    ...
    //console.log(creditTransactionsData)
  // ** State
//   const data = [
//     {
//       name: "US Dollar",
...
const columns = [
  ...
  const CustomPagination = () => (
    <ReactPaginate
      ...
      pageCount={searchValue.length ? filteredData.length / 7 : creditTransactionsData.length / 7 || 1}
      breakLabel={'...'}
  ...
  return (
    ...
    <Card>
      <CardHeader className='border-bottom'>
        <CardTitle tag='h4'>Credit Transactions List</CardTitle>
