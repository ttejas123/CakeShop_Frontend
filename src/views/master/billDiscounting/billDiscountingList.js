      ...
      cell: row => {
        return (
          <div className='d-flex'>
            ...
            <Link  to={`/add-bill-discounting`}><Edit  
                  size={15} 
                  onClick={ () => { 
                                    //setCurrentId(row.id)
                                    //setModal(true)
  ...
  return (
    ...
    <Card>
      <CardHeader className='border-bottom'>
        <CardTitle tag='h4'>Bill Discounting Applications List</CardTitle>
        <Link  to={`/add-bill-discounting`}>
...
export default BillDiscountingList
