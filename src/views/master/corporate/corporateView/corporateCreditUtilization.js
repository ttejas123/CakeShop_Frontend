...
const CorporateCreditUtilization = props => {
    ...
    <Card>
      ...
      <Row className='border-top text-center mx-0'>
        ...
        <Col xs='4' className='border-right py-1'>
          ...
          <h3 className='font-weight-bolder mb-0'>75K</h3>
        </Col>
        <Col xs='4' className='py-1'>
          <CardText className='text-muted mb-0'>Credit Balance</CardText>
          <h3 className='font-weight-bolder mb-0'>25K</h3>
        </Col>
      </Row>
    </Card>
  ) 
}
export default CorporateCreditUtilization
