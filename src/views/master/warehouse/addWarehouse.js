...
import { findStates, findCities, findCountries } from "@store/actions/master/city/editAddCity"
              ...
              <Row>
                <Col md="6" sm="12">
                  <FormGroup>
                    ...
                    <Input
                      ...
                      defaultValue={userData && userData.warehouseName}
                    />
                  </FormGroup>
                </Col>
                <Col md="6" sm="12">
                  <FormGroup>
                    <FormGroup className="mx-auto mt-1 pt-1 d-block">
                      <CustomInput
                        ...
                        name="terms"
                        onClick={(e) => {
                          setValues({ ...values, is_bidoya_wareHouse: e.target.checked })
                        }}
                        id="emailTerms"
                    ...
                    <Col md="4" sm="12">
                      <FormGroup>
                        ...
                        <Select
                          ...
                          onChange={(data) => {
                            useDisplatch(findStates(data.label))
                          }}
                        />
                      </FormGroup>
                    </Col>
                    <Col md="4" sm="12">
                      <FormGroup>
                        ...
                        <Select
                          ...
                          onChange={(data) => {
                            useDisplatch(findCities(data.label))
                          }}
                        />
                      </FormGroup>
                    </Col>
                ...
                <Col className="d-flex flex-sm-row flex-column mt-2" sm="12">
                  <Button.Ripple
                    ...
                    type="submit"
                    color="primary"
                    onClick={() => useDisplatch(CreateWarehouse(values))}
                  >
                    Save Changes
                  </Button.Ripple>
