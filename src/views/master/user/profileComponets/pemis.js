...
<Card>
<CardHeader>
  <CardTitle tag='h1'>Permissions to backup Account</CardTitle>
</CardHeader>
<CardBody>
<Row>
<Col sm='12'>
                ...
                <Table borderless striped responsive>
                  ...
                  <tbody>
                    <tr>
                      <td>Master</td>
                      <td>
                        <CustomInput type='checkbox' disabled id='master-1' label='' defaultChecked />
                      </td>
                      <td>
                        <CustomInput type='checkbox' disabled id='master-2' label='' />
                      </td>
                      <td>
                        <CustomInput type='checkbox' disabled id='master-3' label='' />
                      </td>
                      <td>
                        <CustomInput type='checkbox' disabled id='master-4' label='' />
                      </td>
                    </tr>
                    <tr>
                      <td>Reports</td>
                      <td>
                        <CustomInput type='checkbox' disabled id='reports-1' label='' />
                      </td>
                      <td>
                        <CustomInput type='checkbox' disabled id='reports-2' label='' defaultChecked />
                      </td>
                      <td>
                        <CustomInput type='checkbox' disabled id='reports-3' label='' />
                      </td>
                      <td>
                        <CustomInput type='checkbox' disabled id='reports-4' label='' />
                      </td>
                      </tr>
                    <tr>
                      <td>USer</td>
                      <td>
                        <CustomInput type='checkbox' disabled id='user-1' label='' defaultChecked />
                      </td>
                      <td>
                        <CustomInput type='checkbox' disabled id='user-2' label='' />
                      </td>
                      <td>
                        <CustomInput type='checkbox' disabled id='user-3' label='' defaultChecked />
                      </td>
                      <td>
                        <CustomInput type='checkbox' disabled id='user-4' label='' />
                      </td>
                    </tr>
                  </tbody>
                </Table>
