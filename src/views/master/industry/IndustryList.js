...
import HorizontalForm from './AddIndustry'
import EditForm from './EditIndustry'
...
const handleDelete = (data) => {
  ...
  const CustomPagination = () => (
    <ReactPaginate
      ...
      pageCount={searchValue.length ? filteredData.length / 7 : IndustryData.length / 7 || 1}
      breakLabel={'...'}
  ...
  return (
    ...
    <Card>
      <CardHeader className='border-bottom'>
        <CardTitle tag='h4'>Industry List</CardTitle>
        <Button className='ml-2' color='primary' onClick={handleAddClick}>
              <Plus size={15} />
              <span className='align-middle ml-50'>Add Industry</span>
            </Button>
      </CardHeader>
