    ...
    <Row>
      ...
      <Col md='4' sm='12'>
        <FormGroup>
          ...
          <Input type='text' name='ean' onChange={handleInputeChange} id='ean_upc_code' placeholder='EAN UPC Code' defaultValue={userData && userData.ean} />
        </FormGroup>
      </Col>
      <Col md='4' sm='12'>
        <FormGroup>
          <Label for='hsnCode'>HSN Code</Label>
          <Input type='text' name='hsn' onChange={handleInputeChange} id='hsnCode' placeholder='HSN Code' defaultValue={userData && userData.hsn} />
        </FormGroup>
      </Col>
      <Col md='4' sm='12'>
        <FormGroup>
      ...
      <Col md='12' sm='12'>
        <h4 className='d-block mb-1'>
            ...
            <span className='align-middle'>Category -- ( {userData.category ? userData.category.label : ""} ) current Sellected</span>
        </h4>
      </Col>
